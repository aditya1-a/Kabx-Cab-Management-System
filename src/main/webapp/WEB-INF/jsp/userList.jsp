							...
							<tbody id="userTable">
                                <c:if test="${not empty customers}">
                                    <c:forEach var="customer" items="${customers}">
                                        <tr>
                                            <td><input type="checkbox" name="selectedIds" value="${customer.userid}"></td>
											<td>
                                                <c:out value="${customer.userid}"></c:out>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <c:out value="${customer.phoneNo}"></c:out>
                                            </td>
                                            <td>
                                                <c:out value="${customer.gender}"></c:out>
                                            </td>
                                            <td>
                                                <c:out value="${customer.accountHolderType}"></c:out>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                </c:if>
